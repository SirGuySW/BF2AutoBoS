...
settings.messages = {};
settings.messages.WRITE_KICK_WARNINGS = true;				//Should we display warnings before kicking (ie: "WARNING!!! <PlayerName> |ccc| YOU MUST CHANGE YOUR NAME!!!");
	settings.messages.KICK_MESSAGE_DELAY = 30000;			//Time to wait before sending warning messages for kicks (in miliseconds)(this will also delay the kick);
